...
εκτελείται ο παρακάτω αλγόριθμος reverse Assignment Hypecube (η συνθήκη σύγκλησης ελέγχεται μετά την 2η επανάληψη του αλγορίθμου καθώς τότε πλέον θα έχουμε "παλιά κεντροειδή"), αναλυτικά:
